# A flag HAS_ML precisa ser importada globalmente, usaremos a do config.
...
class AnalisadorContextoAvancado:
    ...
    def mapear_padroes_geometria(sub_pol):
        ...
        if texto.endswith("VVVV"): return "SATURAÇÃO ESTRUTURAL (V)"
        if texto.endswith("PPPP"): return "SATURAÇÃO ESTRUTURAL (P)"
